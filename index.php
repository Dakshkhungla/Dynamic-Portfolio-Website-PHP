<?php include('./include/DAO.php');

$result = getdata("SELECT * FROM basic_setup,personal_setup,aboutus_setup");
...
<body>
    ...
    <main id="main">
        ...
        // $result=getdata("SELECT * FROM skills");
        ...
        <!-- ======= Resume Section ======= -->
        <section id="resume" class="resume" style="background-color:lightblue">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-6" data-aos="fade-up">
                        ...
                        $runquery4 = getdata("SELECT * FROM resume WHERE category='e'");
                    ...
                    <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
                        ...
                        $runquery4 = getdata("SELECT * FROM resume WHERE category='pe'");
                        while ($data4 = mysqli_fetch_array($runquery4)) {
                        ?>
                            <div class="resume-item">
                                <h4><?= $data4['title'] ?></h4>
        ...
        <section id="portfolio" class="portfolio section-bg">
            <div class="container">
                ...
                <div class="row portfolio-container" data-aos="fade-up" data-aos-delay="100">
                    ...
                    $runquery5 = getdata("SELECT * FROM portfolio");
                    while ($data5 = mysqli_fetch_array($runquery5)) {
                    ?>
                        <div class="col-lg-4 col-md-6 portfolio-item">
                            <div class="portfolio-wrap">
                                <img src="assets/img/<?= $data5['projectpic'] ?>" style="height:300px;width:400px;" class="img-fluid" alt="">
            ...
            <div class="container">
                ...
                <div class="row" data-aos="fade-in">
                    ...
                    <div class="col-lg-7 mt-5 mt-lg-0 d-flex align-items-stretch">
                        <form action="include/send_msg.php" method="POST" role="form" class="php-email-form">
                            <div class="form-row">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="sent-message">The MMessage Was Sent</div>
                            </div>
                            <div class="text-center"><input type="submit" class="btn btn-primary" value="Send Message" name="sub" /></div>
                        </form>
                    </div>
                    <!--
...
-->
            <div class="credits">
                Developed by <a href="#">Daksh & Rudra</a>
            </div>
        </div>
    </footer><!-- End  Footer -->
